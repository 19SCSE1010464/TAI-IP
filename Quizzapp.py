...
questionLabel = Label(root,text=question.get(),fg='gold',font=('arial',20))
questionLabel.grid(row=2,column=0)
...
scoreLabel.grid(row=5, column=0)
submitButton = Button(root,text="Restart",fg='green',bg='pink',font=("arial",15),command=restart,width=35)
